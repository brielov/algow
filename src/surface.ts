...
export const svar = (name: string, span?: Span): SVar => ({ kind: "SVar", name, span });
...
export const spvar = (name: string, span?: Span): SPVar => ({ kind: "SPVar", name, span });
...
export const spas = (name: string, pattern: SPattern, span?: Span): SPAs => ({
  kind: "SPAs",
  name,
  pattern,
  span,
